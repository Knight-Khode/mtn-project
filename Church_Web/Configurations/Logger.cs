...
namespace Church_Web.Configurations
{
    public class Logger
    {
        ...
        public void logError(Exception x)
        {
            try
            {
                ...
                var logFileName = string.Format("ChurchPortal_error_{0}_{1}.log", DateTime.Now.ToString("yyyy_MM_dd"), DateTime.Now.ToString("HH"));
        ...
        public void logInfo(string message)
        {
            try
            {
                ...
                var logFileName = string.Format("ChurchPortal_Info_{0}_{1}.log", DateTime.Now.ToString("yyyy_MM_dd"), DateTime.Now.ToString("HH"));
                var logFilePath = Path.Combine(dir, logFileName);
        ...
        public void logWarning(string message)
        {
            lock (Locker)
            {
                try
                {
                    ...
                    var logFileName = string.Format("ChurchPortal_Warning_{0}_{1}.log", DateTime.Now.ToString("yyyy_MM_dd"), DateTime.Now.ToString("HH"));
                    var logFilePath = Path.Combine(dir, logFileName);
